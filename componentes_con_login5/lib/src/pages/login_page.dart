        ...
        return Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
                hintText: 'uis@hotmail.com',
                labelText: 'Correo Electrónico',
                helperText: 'solo es el Correo Electrónico',
...
/*             final response =
                await _dbService.signInUser(_user, password.text.trim()); registrar*/
            ...
            if (resp['status'] == 200) {
              ...
              switch (_user.rol) {
                ...
                case 'Paciente':
                  ...
                  break;
                case 'Domiciliario':
                  Navigator.pushReplacementNamed(context, "domiciliario",
                      arguments: _user);
                  break;
                default:
                  break;
