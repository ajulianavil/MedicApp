...
import 'package:componentes/src/pages/cart.dart';
...
Map<String, WidgetBuilder> getApplicationRoutes() {
  return <String, WidgetBuilder>{
    ...
    'formulas': (BuildContext context) => MedsRequestPage(),
    'pedidos': (BuildContext context) => ReviewOrderPage(),
    'cart': (BuildContext context) => PatientOrderPage(),
    'pedidosaceptados': (BuildContext context) => PedidoAceptado(),
  };
}
