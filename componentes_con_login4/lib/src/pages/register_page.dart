...
/*   Widget _crearNombres() {
  ...
  Widget _crearRol() {
    return DropdownButton<String>(
      ...
      items: <String>['Administrador', 'Paciente', 'Domiciliario']
  ...
  Widget _crearGenero() {
    return DropdownButton<String>(
      ...
      items:
          <String>['F', 'M', 'O'].map<DropdownMenuItem<String>>((String value) {
        return DropdownMenuItem<String>(
          value: value,
          child: Text(value),
        );
